  ...
  selectedScene.tags.forEach((tag) => {
    ...
    if (type === "door") {
      ...
      tagElement.className =
        'flex items-center gap-2 border-b-custom-gray p-2 border-b border-solid cursor-pointer before:content-[url("../assets/svg/door-closed-dark.svg")]';
    } else if (type === "text") {
      tagElement.setAttribute("data-type", "text");
      tagElement.className =
        'flex items-center gap-2 border-b-custom-gray p-2 border-b border-solid cursor-pointer before:content-[url("../assets/svg/card-text-dark.svg")]';
    } else if (type === "photo") {
      tagElement.setAttribute("data-type", "photo");
      tagElement.className =
        'flex items-center gap-2 border-b-custom-gray p-2 border-b border-solid cursor-pointer before:content-[url("../assets/svg/file-image-dark.svg")]';
    } else if (type === "infoBulle") {
      tagElement.setAttribute("data-type", "infoBulle");
      tagElement.className =
        'flex items-center gap-2 border-b-custom-gray p-2 border-b border-solid cursor-pointer before:content-[url("../assets/svg/info-circle-dark.svg")]';
    }
...
export function AddSceneExplorer(newtag, type) {
  ...
  if (type === "door") {
    ...
    tagElement.className =
      "flex items-center gap-2 border-b-custom-gray p-2 border-b border-solid cursor-pointer";
