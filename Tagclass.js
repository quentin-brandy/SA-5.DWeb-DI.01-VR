...
export class InfoBulle extends TagManager {
    addInfoBulleTag(name, position, rotation = {}, title = "Sample Title", desc = "Sample Description", titleColor = '#000', descColor = '#000', radius = '0.5', isVisible = false) {
        return this.addTag('infoBulle', name, position, rotation, { title, desc, titleColor, descColor, radius, isVisible });
    }
